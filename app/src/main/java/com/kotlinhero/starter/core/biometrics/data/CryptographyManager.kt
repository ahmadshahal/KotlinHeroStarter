package com.kotlinhero.starter.core.biometrics.data
...
interface CryptographyManager {
     ...
     */
    fun encryptData(plaintext: String, cipher: Cipher): CipherText
...
internal class CryptographyManagerImpl : CryptographyManager {
     ...
     */
    override fun encryptData(plaintext: String, cipher: Cipher): CipherText {
