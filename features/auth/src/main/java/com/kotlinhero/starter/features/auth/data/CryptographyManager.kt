...
interface CryptographyManager {
     ...
     */
    fun encryptData(plaintext: String, cipher: Cipher): com.kotlinhero.starter.features.auth.domain.entities.CipherText
...
internal class CryptographyManagerImpl : CryptographyManager {
     ...
     */
    override fun encryptData(plaintext: String, cipher: Cipher): com.kotlinhero.starter.features.auth.domain.entities.CipherText {
        val ciphertext = cipher.doFinal(plaintext.toByteArray(Charset.forName("UTF-8")))
        return com.kotlinhero.starter.features.auth.domain.entities.CipherText(ciphertext, cipher.iv)
    }
